...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_4QFMHRZP_js__WEBPACK_IMPORTED_MODULE_0__.FormElement;
    for(i in newProps){
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.capitalize)((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && compName in _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (oldValue) {
...
function setStyle(style, key, value) {
    ...
    style[key] = (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? value + "px" : value == null ? "" : value;
}
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(oldValue)) {
            ...
            if ((0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(value)) {
    ...
    } else if (!(0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_4QFMHRZP_js__WEBPACK_IMPORTED_MODULE_0__.document$1.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_4QFMHRZP_js__WEBPACK_IMPORTED_MODULE_0__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_4QFMHRZP_js__WEBPACK_IMPORTED_MODULE_0__.document$1.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    afterActiveInstanceBlur: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    preparePortalMount: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    prepareScopeUpdate: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    resetTextContent: _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_IFYECHNS_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
